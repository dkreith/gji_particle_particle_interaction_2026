...
for p in ["0", "50", "100"]:
    ...
    if p == "0":
        specs_0_2.append((dat_comp_2[0], spec_rs_2))
        specs_0_3.append((dat_comp_3[0], spec_rs_3))
    elif p == "50":
        specs_50_2.append((dat_comp_2[0], spec_rs_2))
        specs_50_3.append((dat_comp_3[0], spec_rs_3))
    if p == "100":
        specs_100_2.append((dat_comp_2[0], spec_rs_2))
...
ii = 0
for spec_0 in specs_0_2:
    if (spec_0[1] == specs_0_2[-1][1]).all():
        ax0.semilogx(spec_0[0], spec_0[1].real, "k--")
    else:
        ax0.semilogx(spec_0[0], spec_0[1].real, color=col[ii],
                     linewidth=2)
...
for spec_0 in specs_0_2:
    if (spec_0[1] == specs_0_2[-1][1]).all():
        ...
        ax1.semilogx(spec_0[0], spec_0[1].imag, color=col[ii],
                     linewidth=2)
        ii += 1
ax1.set_ylim([-0.1e-6, 2.5e-6])

ii = 0
for spec_50 in specs_50_2:
    if (spec_50[1] == specs_50_2[-1][1]).all():
        ax2.semilogx(spec_50[0], spec_50[1].imag, "k--")
    else:
        ax2.semilogx(spec_50[0], spec_50[1].imag, color=col[ii],
                     linewidth=2)
...
ii = 0
for spec_100 in specs_100_2:
    if (spec_100[1] == specs_100_2[-1][1]).all():
        ax3.semilogx(spec_100[0], spec_100[1].imag, "k--")
    else:
        ax3.semilogx(spec_100[0], spec_100[1].imag, color=col[ii],
                     linewidth=2)
...
fig.tight_layout()
fig.savefig("Figures/para_spec_2d.png", dpi=300, bbox_inches="tight")
